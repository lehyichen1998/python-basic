...
url = 'http://web.juhe.cn:8080/constellation/getAll?key=212a7e1b3f9c5002dd440372b583bd64&consName=狮子座&type=today'
# 秘钥 id；
##########################################################################Key：212a7e1b3f9c5002dd440372b583bd64
##########################################################################key：e4f70a414b69541546fbbf631c70737f
...
def today():
    ...
    try:
        ...
        if r is None and data_time is None:  # 当没有参数输入时显示默认
            pass
            result = requests.get('http://web.juhe.cn:8080/constellation/getAll?key=212a7e1b3f9c5002dd440372b583bd64'
